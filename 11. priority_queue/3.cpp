...
int main ()
{
    priority_queue <Batsman,vector<Batsman> , comByRun> pq ;

    pq.emplace("Asif",150,2,6) ;
    pq.emplace("Saha",28,2,6) ;
    pq.emplace("nil",291,2,6) ;
    pq.emplace("vai",47,2,6) ;
    pq.emplace("abbu",87,2,6) ;
